"""
    Generate simulated room impulse responses and binaural microphone signals for Speech Commands v2.

    Examples:
        python gen_simu_speechcommands.py --stage pretrain --data_num 84843 --sc_root /scratch/yotam/ssamba/src/finetune/speechcommands_v2/data/speech_commands_v0.02 --label_csv /scratch/yotam/ssamba/src/finetune/speechcommands_v2/data/speechcommands_class_labels_indices.csv --save_to ../../data/SpeechCommands/simu --gpus [0,1]
        python gen_simu_speechcommands.py --stage preval --data_num 9981 --sc_root /scratch/yotam/ssamba/src/finetune/speechcommands_v2/data/speech_commands_v0.02 --label_csv /scratch/yotam/ssamba/src/finetune/speechcommands_v2/data/speechcommands_class_labels_indices.csv --save_to ../../data/SpeechCommands/simu --gpus [0]
        python gen_simu_speechcommands.py --stage pretest --data_num 11005 --sc_root /scratch/yotam/ssamba/src/finetune/speechcommands_v2/data/speech_commands_v0.02 --label_csv /scratch/yotam/ssamba/src/finetune/speechcommands_v2/data/speechcommands_class_labels_indices.csv --save_to ../../data/SpeechCommands/simu --gpus [0]
"""
import os
cpu_num = 8
...
def GenerateRandomMicSigSpeechCommands(
    ...
    c: float=343.0,
    ism_db: float=12,
    T: float=2.0, # 2.0s duration container for Speech Commands (1.0s keyword + 1.0s reverb tail decay)
    sc_root: str='',
    label_csv: str='',
    noi_dir: str='',
    stage: str='pretrain',
    ...
    srcdataset = SpeechCommandsForSimuDataset(
        sc_root=sc_root,
        label_csv=label_csv,
        split=stage,
        T=T,
    ...
    print(f'Speech Commands source dataset: {len(srcdataset)} items, T={T}s, split={stage}')
    ...
    pbar.set_description(f'SpeechCommands ({stage}) micro-signals')
...
if __name__ == '__main__':
    parser = ArgumentParser(description='Generate spatialized Speech Commands data')
    parser.add_function_arguments(GenerateRandomMicSigSpeechCommands)
    args = parser.parse_args()
    GenerateRandomMicSigSpeechCommands(**vars(args))
